...
Public Module Helper
    ...
    Private Sub DrawAnimation(Target As Form, g As Graphics, rect As Rectangle, percentage As Single)
        ...
        Using fnt As New Font(Target.Font.FontFamily, 14)
            Dim text As String = "Loading... " + percentage.ToString + "%"
